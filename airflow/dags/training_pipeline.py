...
with DAG(                         # Directed Acyclic Graph
    'multiplication_training',            # Name for DAG
    ...
    start_date=pendulum.datetime(2023, 15, 8, tz="UTC"),   # Start date for pipeline -> yyyy,mm,dd
    ...
    def training(**kwargs):                                                      # Defining function for training pipeline
        from multiplicationTable.pipeline.training_pipeline import start_training_pipeline    # Starting training pipeline from thyroid
