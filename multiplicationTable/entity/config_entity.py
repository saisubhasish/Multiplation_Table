...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        try:
            self.database_name="MultiplicationTable"
            self.collection_name="Multiplication"
...
class DataTransformationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        try:
            ...
            self.transform_object_path = os.path.join(self.data_transformation_dir,"target_encoder",TRANSFORMER_OBJECT_FILE_NAME)
